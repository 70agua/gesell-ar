  ...
  return (
    <div style={{ minHeight:'100vh', background:'#fff', fontFamily:"'Inter', system-ui, sans-serif", color:C.ink, paddingTop:70 }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center' }}>
            ...
            <div>
              ...
              <div style={{ display:'flex', alignItems:'center', gap:6, fontSize:13, color:'rgba(255,255,255,0.5)', marginBottom:28 }}>
                <button onClick={onBack} style={{ background:'none', border:'none', color:'rgba(255,255,255,0.7)', fontSize:13, fontWeight:600, cursor:'pointer', padding:0 }}>Cupopacks</button>
              ...
              <div style={{ display:'flex', flexWrap:'wrap', gap:20, marginBottom:36 }}>
                {[
                  ...
                  {icon:<Check size={13} color={C.green} strokeWidth={2.5}/>, label:'Cupopack verificado', color:C.green},
                ].map((s,i)=>(
              ...
              <div style={{ display:'flex', alignItems:'center', gap:20, flexWrap:'wrap' }}>
                <div>
                  <div style={{ fontSize:12, color:'rgba(255,255,255,0.45)', fontWeight:600, textTransform:'uppercase', letterSpacing:'0.06em', marginBottom:2 }}>Cupopack completo desde</div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:80, alignItems:'start' }}>
            ...
            <div style={{ paddingTop:8 }}>
              <p style={{ fontSize:17, lineHeight:1.7, color:C.ink2, margin:0 }}>
                {pack.description ||
                  'Armamos este Cupopack para que no pierdas tiempo eligiendo entre decenas de cupones. Beneficios en gastronomía, salidas y experiencias, ya seleccionados.'}
              </p>
          ...
          <div style={{ maxWidth:1328, margin:'0 auto', padding:'0 40px' }}>
            <div style={{ marginBottom:36 }}>
              ...
              <h2 style={{ fontSize:'clamp(24px,3vw,38px)', fontWeight:900, letterSpacing:'-0.025em', margin:0 }}>
                Cupones de regalo con tu Cupopack
              </h2>
            </div>
        ...
        <div style={{ position:'relative', maxWidth:1328, margin:'0 auto', padding:'80px 40px' }}>
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:72, alignItems:'start' }}>
            ...
            <div style={{ background:'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.12)', borderRadius:24, padding:32, backdropFilter:'blur(12px)' }}>
              ...
              >
                Sumar este Cupopack <ArrowRight size={18}/>
              </button>
      ...
      <div style={{
        ...
        <div style={{ flex:1 }}>
          <div style={{ fontSize:11, color:C.muted, fontWeight:500 }}>Cupopack completo desde</div>
