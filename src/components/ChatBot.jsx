...
const FAQS = [
  ...
  { id: 4,  cat: 'Pase',      q: '¿Cómo sumo una oferta a mi carrito?',            keywords: ['agregar','añadir','sumar oferta','añadir oferta','carrito'],          a: 'Con el Cupon PASS ya las tenés: la mayoría de los descuentos vienen incluidos. Los PREMIUM (más de $40.000 de ahorro) los elegís vos: entra uno por cada día de pase, y si querés más, los sumás sueltos a mitad de precio.' },
  ...
  { id: 14, cat: 'Mi cuenta',     q: '¿Es gratis usar Cuponear?',                      keywords: ['gratis','gratuito','costo','cobran','pago','sin cargo'],              a: 'Registrarte y explorar los descuentos es gratis. Para usarlos comprás el Cupon PASS (una vez, desde $20.000) o cupones sueltos.' },
...
const MENSAJES_VIEW = {
  marketplace:          { titulo: 'Tocá cualquier cupón para ver el detalle.', sub: 'La mayoría vienen incluidos en el Cupon PASS.', extendido: 'En el listado, cada tarjeta es un cupón de un socio. Con el pase, la mayoría ya los tenés incluidos; los de más de $40.000 de ahorro los elegís (uno por día de pase) o los sumás sueltos a mitad de precio. Después los activás cuando estés en el local. ¿Te cuento cómo funciona el pase?' },
  'marketplace-ofertas':{ titulo: 'Tocá cualquier cupón para ver el detalle.', sub: 'La mayoría vienen incluidos en el Cupon PASS.', extendido: 'En el listado, cada tarjeta es un cupón de un socio. Con el pase, la mayoría ya los tenés incluidos; los PREMIUM los elegís o los sumás a mitad de precio. Después los activás cuando estés en el local. ¿Te cuento cómo funciona el pase?' },
  ofertas:              { titulo: 'Tocá cualquier cupón para ver el detalle.', sub: 'La mayoría vienen incluidos en el Cupon PASS.', extendido: 'Cada tarjeta es un cupón de un socio. Con el pase la mayoría ya los tenés incluidos; los PREMIUM los elegís o los sumás a mitad de precio. Después los activás en el local. ¿Te cuento cómo funciona el pase?' },
  salidas:              { titulo: 'Tocá cualquier cupón para ver el detalle.', sub: 'La mayoría vienen incluidos en el Cupon PASS.', extendido: 'Cada tarjeta es un cupón de un socio de Salidas. Con el pase la mayoría ya los tenés incluidos; los PREMIUM los elegís o los sumás a mitad de precio. Después los activás en el local. ¿Te cuento cómo funciona el pase?' },
  'oferta-detail':      { titulo: 'Activá este cupón y mostralo en el local.', sub: 'Con el Cupon PASS ya lo tenés — o lo sumás suelto.', extendido: 'Cuando estés en el local tocá "Activar" y mostrale la pantalla al comercio. La activación tiene su vigencia, así que activalo recién cuando vayas a consumir. ¿Alguna duda con el pase?' },
