...
const FAQS = [
  ...
  { id: 4,  cat: 'Cuponera',      q: '¿Cómo sumo una oferta a mi cuponera?',            keywords: ['agregar','añadir','sumar oferta','añadir oferta','cuponera'],          a: 'Con el Gesell PaSS ya las tenés: la mayoría de los descuentos vienen incluidos. Los PLUS (más de $15.000 de ahorro) los elegís vos: entra uno por cada día de pase, y si querés más, los sumás sueltos a mitad de precio.' },
  { id: 10, cat: 'Cuponera',      q: '¿Puedo usar los cupones en cualquier momento?',   keywords: ['usar','cuándo','momento','activar','canjear','disponible'],            a: 'Los que necesitan reserva previa (alojamiento, spa, excursiones) los usás anticipadamente. El resto, en las fechas que elijas, mientras dure tu pase.' },
...
const FAQ_CATS = ['Cuponera', 'Puntos', 'Ofertas', 'Alojamientos', 'Mi cuenta', 'Socios', 'Ayuda'];
